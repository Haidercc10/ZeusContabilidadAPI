...
{
    public partial class EsquemaCondicionLog
    {
        public EsquemaCondicionLog()
        {
            EsquemaCondicionTransaccionesLogs = new HashSet<EsquemaCondicionTransaccionesLog>();
        }
        ...
        public int IdenEsquemaCondicionLog { get; set; }

        public virtual Esquema EsquemaNavigation { get; set; } = null!;
        public virtual ICollection<EsquemaCondicionTransaccionesLog> EsquemaCondicionTransaccionesLogs { get; set; }
    }
}
