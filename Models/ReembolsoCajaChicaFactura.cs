...
{
    public partial class ReembolsoCajaChicaFactura
    {
        public decimal Iden { get; set; }
        public decimal IdenReembolsoCajaChica { get; set; }
        public int Tipo { get; set; }
        public string Rendicion { get; set; } = null!;
        public string FechaCaja { get; set; } = null!;
        public string Empleado { get; set; } = null!;
        public string Bu { get; set; } = null!;
        public string FuenteCompra { get; set; } = null!;
        public string DocumentoCompra { get; set; } = null!;
